...
export default function Menu({className, closeMenu}) {
    ...
    return (
        ...
        <div className={` p-6 bg-white absolute top-0 left-0 w-full flex flex-col transition-all lg:space-x-4 lg:py-0 lg:px-0 lg:flex-row lg:relative lg:tranlate-y-0 r py-6 space-y-4 ${className}` }>
                    ...
                    <Button className="w-80 bg-tertiary_orange lg:mt-0">
                        QUERO COMEÇAR AGORA 
                        <setaButton className="bg-primary_blue_dark"/>
                    </Button>
